...
export type UserByIdQuery = { __typename?: 'query_root', users_by_pk?: Maybe<{ __typename?: 'users', created_at: any, id: string, name: string, email: string, profile_photo_url: string, updated_at: any }> };
